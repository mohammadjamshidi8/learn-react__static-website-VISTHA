...
export default function ServiceBox({icon,title,text}) {
  ...
  return (
    <div className="relative flex flex-col items-start gap-y-6 transition duration-700 bg-gray-100 p-5 rounded-xl hover:bg-green-100 cursor-pointer hover:-translate-y-4 overflow-hidden group z-20">
